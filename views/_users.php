                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">üzvlər</strong>
                        </div>
                        <div class="card-body">
                            <table class="table">
                                <thead>
                                ...
                                <tbody>
                                <?php $users = (new Database)->getUsers(); ?>
                                <?php foreach ($users as $user): ?>
                                    <tr>
                                        <th scope="row"><?= $user->id ?></th>
                                        <td><?= $user->username ?></td>
                                        <td>+<?= $user->phone ?></td>
                                        <td><?= $user->price ?> AZN</td>
                                        <td><a href="<?= base_url() . '/edit_user.php?id=' . $user->id ?>" class="btn btn-link">redaktə et</a></td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
