    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="menu-title"><?= user()->username . ' - ' . price() . ' AZN' ?></li>
                <li class="active">
                    <a href="index.html"><i class="menu-icon fa fa-laptop"></i>Admin Panel</a>
                </li>
                <li class="menu-title">Bölmələr</li>
                <li class="menu-item">
                    <a href="#"> <i class="menu-icon fa fa-table"></i>Tarixcə</a>
                    <a href="#"> <i class="menu-icon fa fa-table"></i>Yoxlanış</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="content">
        <div class="animated fadeIn">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">Siyahısı</div>
                        <div class="card-body card-block">
                            <form action="#" method="post" class="">
                                <div class="form-group">
                                    <label for="company" class="form-control-label">Şirkət adı</label>
                                    <input type="text" id="company" name="name" placeholder="şirkət adı" class="form-control"></div>
                                    <div class="form-actions form-group">
                                        <button type="submit" class="btn btn-success btn-sm">Əlavə et</button>
                                    </div>
                            </form>
                        </div>
                    </div>
